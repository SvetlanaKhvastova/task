...
.after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(4) {
  margin-bottom: 0 !important;
}
.after-refresh .count_sec:nth-of-type(22) .guarantee img {
...
.after-refresh .count_sec:nth-of-type(3) .enroll_now_lite{
...
.after-refresh .count_sec:nth-of-type(6) .enroll_now_lite {
  margin: 40px 0 10px;
  padding: 0;
}
...
.after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(2),
.after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(3) {
  padding: 0 20px;
  display: block;
}
.after-refresh .count_sec:nth-of-type(22) i.fa.fa-quote-left {
  left: 0;
}
.after-refresh .count_sec:nth-of-type(22) span.text_faa_left {
  margin: 0 !important;
}
...
.after-refresh .count_sec:nth-of-type(11) .col-md-12,
.after-refresh .count_sec:nth-of-type(15) .col-md-12{
float: unset;
}
...
.after-refresh .count_sec:nth-of-type(23) .all_content.eighttn_red_spc > .row.row1030   {
  display: none;
}
.after-refresh .count_sec:nth-of-type(20) h2 {
  margin-bottom: 2px;
}
.after-refresh .count_sec:nth-of-type(20) .enroll_now_main {
  padding: 0;
}
.after-refresh .count_sec:nth-of-type(20) .enroll_now_main > a {
  margin-top: 16px !important;
}
...
.after-refresh .count_sec:nth-of-type(22) .enroll_now_main {
  padding: 0;
}
.after-refresh .count_sec:nth-of-type(22) .enroll_now_main > a {
  margin-top: 32px !important;
}
.after-refresh .count_sec:nth-of-type(24) h2 {
  margin-bottom: 2px;
  font-style: italic;
}
@media (min-width: 992px){
  .after-refresh .count_sec:nth-of-type(24) .flowplayer_video_container.interview_video,
.after-refresh .count_sec:nth-of-type(8) .flowplayer_video_container.interview_video_in{
  padding-top: 51.25%;
  max-width: 318px;
    margin: 0 !important;
}
.after-refresh .count_sec:nth-of-type(24) .row.row1030 .content > .col-md-6:nth-child(1),
.after-refresh .count_sec:nth-of-type(8) .row.row1030 .content > .col-md-6:nth-child(1){
  width: 36%;
    padding-right: 0;
}
.after-refresh .count_sec:nth-of-type(24) .row.row1030 .content > .col-md-6.interview_last_video,
.after-refresh .count_sec:nth-of-type(8) .row.row1030 .content > .col-md-6:nth-child(2){
  width: 64%;
    padding-right: 0;
}
    }
body .after-refresh .count_sec:nth-of-type(24) .enroll_now_main {
  padding: 0;
}
body .after-refresh .count_sec:nth-of-type(24) .enroll_now_main > a {
  margin-top: 22px !important;
}
.all_content > .bottom_space_add {
  padding-bottom: 50px;
}
.after-refresh .count_sec:nth-of-type(24) .quick_transcript > p:nth-child(1) {
  padding: 0 20px;
}
...
.after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(4) span:nth-child(1),
.after-refresh .count_sec:nth-of-type(24) .quick_transcript > p:nth-child(2) span:nth-child(1) {
  font-weight: 700;
  display: block;
  font-size: 16px;
  line-height: 22px;
...
.after-refresh .count_sec:nth-of-type(6) .pattern-block .row1030 .col-md-12 > p:not(.sub_head_examples):nth-child(4) span:nth-child(1), .after-refresh .count_sec:nth-of-type(8) .quick_transcript_one p:nth-child(2) span:nth-child(1), .after-refresh .count_sec:nth-of-type(10) .content > .col-md-8 p:nth-child(5) span:nth-child(1), .after-refresh .count_sec:nth-of-type(13) .content > .col-md-8 p:nth-child(4) span:nth-child(1), .after-refresh .count_sec:nth-of-type(15) .content > .col-md-8 p:nth-child(6) span:nth-child(1), .after-refresh .count_sec:nth-of-type(16) .row1030 > .col-md-12:not(.aftermasterclass) > p:nth-child(4) span:nth-child(1), .after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(4) span:nth-child(1), .after-refresh .count_sec:nth-of-type(24) .quick_transcript > p:nth-child(2) span:nth-child(1){
  font-size: 14px;
    line-height: 19px;
}
...
.after-refresh .count_sec:nth-of-type(22) i.fa.fa-quote-left,
.after-refresh .count_sec:nth-of-type(24) i.fa.fa-quote-left{
  top: -12px;
}
...
.after-refresh .count_sec:nth-of-type(22) i.fa.fa-quote-right,
.after-refresh .count_sec:nth-of-type(24) i.fa.fa-quote-right {
  bottom: -10px;
}
.after-refresh .count_sec:nth-of-type(15) .enroll_now_main {
    margin: 4px 0 0;
...
.after-refresh .count_sec:nth-of-type(21) .seventn_red_spc {
    padding-bottom: 40px !important;
}
.after-refresh .count_sec:nth-of-type(21) p:last-child {
  margin-bottom: 28px !important;
}
.after-refresh .count_sec:nth-of-type(21) img{
...
.after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(2), .after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(3) {
    padding: 0;
}
...
body .after-refresh .count_sec:nth-of-type(24) .flowplayer_video_container {
    padding-top: 59% !important;
}
body .after-refresh .count_sec:nth-of-type(24) .quick_transcript {
    margin-top: 20px;
}
}
...
.time_offer_box .body_wrap > p, .img_guarantee span{
  font-size: 12px !important;
    ...
    let arrQuestion = {
      ...
      2: [`2. I want to start the course later. Is It possible to buy today but start later?`, `<p>No worries! You can snag the special deal today and hold off on getting started until later. Just give us a shout after you buy to let us know you want to delay the start of your dog's training course.</p>`],
      3: [`3. Does the masterclass work better for puppies or adult dogs?`, `<p>The masterclass works equally well both for puppies and adult dogs. Puppies as young as 8 weeks and adult dogs as old as 13 years have been successfully trained using the masterclass.</p>`],
      4: [`4. Can I use the program to train multiple dogs?`, `<p>Absolutely! Once you've got the course, you're set for life. The knowledge inside is yours to use as much as you want, whether you're training 2 dogs or 20. So you can keep using the Total Transformation Masterclass to train all your furry friends now and in future, until they're just as well-behaved as a service dog.</p>`],
      5: [
      ...
      9: [`9. Is the masterclass open to non-U.S. residents?`, `<p>Absolutely, it’s available worldwide. We actually have had participants from 42 different countries outside the U.S. (Canada, United Kingdom, Australia, South Africa, New Zealand, Singapore, Germany, Mexico, India, Israel, Brazil, Japan, South Korea, etc.)</p>`],
      10: [
      ...
      12: [`12. What if I have already taught my dog using verbal commands like sit, stay, etc.?`, `<p>Don’t worry - your dog can easily unlearn their previous training and master the new training that you’ll learn in the masterclass.</p>`],
      13: [
      ...
      14: [`14. Will I need to constantly give treats to my dog throughout their lives in order to get them to listen to me?`, `<p>No, the masterclass will teach you how to wean your dog away from treats so that they continue to listen to you even without any food bribes. 🙂</p>`],
    };
    let arrInfo = {
      1: [`<span>Weeks 1 and 2</span><span>How to get your dog's undivided attention</span>`, `<p>Discover the 6-step process service dog trainers use to get dogs to become calm and obedient, as well as the WATCH and TOUCH commands to grab your dog’s attention without relying only on treats.</p>`],
      2: [`<span>Week 3:</span><span>How to get your dog to sit still in any situation</span>`, `<p>Even if your dog already knows how to sit, learn the special way service dog trainers train dogs to SIT, which leads to far better and longer-lasting results.</p>`],
      3: [`<span>Week 4:</span><span>How to stop your dog from pulling on the leash</span>`, `<p>Learn how to train your dog to walk calmly by your side, no matter how fast or slow you go. Also, you'll learn the SAY HELLO command which allows your dog to calmly greet other dogs or people, only when you give permission.</p>`],
      4: [`<span>Week 5:</span><span>How to read your dog like a book</span>`, `<p>Did you know that a wagging tail doesn't always mean your dog is happy? Avoid common mistakes likes these and learn how to read your dog's body language so you can train them more effectively at times when they are most receptive to your lessons.</p>`],
      5: [`<span>Week 6:</span><span>How to stop your dog from barking at the door, being aggressive, and destroying your home</span>`, `<p>Learn how to give your dog a job to do (like going to their bed) so they stop barking when the doorbell rings or someone visits. Also, find out how to prevent destructive chewing and 'resource guarding', which is when your dog gets aggressive when someone tries to take their toys or food away.</p>`],
      6: [`<span>Week 7:</span><span>How to train your dog to have good manners: calm at mealtimes, polite greetings for guests, and no more jumping</span>`, `<p>Learn how to stop your dog from jumping on you when you come home, during mealtimes, etc.</p><p>Also learn how to teach your dog to calmly greet your guests instead of jumping on them and avoid dominant – sometimes dangerous – behavior in larger adult dogs.</p>`],
      7: [`<span>Week 8:</span><span>How to get your dog to come to you whenever you call them</span>`, `<p>We'll teach you some cool games to get your dog to come running when you call their name, even if they're busy chasing a squirrel.</p>`],
      8: [`<span>Week 9:</span><span>How to take control of impulsive behavior</span>`, `<p>Train your furry friend to be calm and still in any situation using advanced obedience and impulse control techniques known only to service dog trainers.</p>`],
      9: [`<span>Week 10:</span><span>How to get your dog to behave well in public</span>`, `<p>Learn to handle 'leash reactivity' and aggression towards other dogs using WATCH, TOUCH and other techniques. Discover how to have your dog automatically sit when you stop walking, as well as stop at curbs to wait for instructions before crossing a road – which can save your dog's life.</p>`],
    };
    let reviewsBox = /*html */ `
    ...
    let tenWeekBox = /*html */ `
        <div class="ten_week_bgr">
            <div class="ten_week_box">
                <h2><span>10-week online dog training program</span></h2>
                <div class="all_inform_wrap">
                    ...
                    <h3>Here’s what you’ll learn in this 10-week online masterclass:</h3>
                ...
                <div class="time_offer_box">
                    ...
                    <div class="body_wrap">
                      ...
                      <button class="new_enroll_now_btn time_offer_visab">Enroll Now - Lite Version <svg width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="text_descr_var">
      ...
      <p class="italic_text_var">We had several problems with Lucy before we joined the masterclass. She used to have
        accidents in our house. And she would also be over-protective of me and would bark at
        any person that we met during our walks. After we implemented what we learned in
        your bonus housebreaking class, she hasn't had an accident in more than 5 months
        now. And instead of barking at other people, she looks to me for instructions regarding
        what to do, and when I tell her to say hello, she calmly goes and well... says hello to the
        person!
      </p>
    ...
    document.querySelectorAll(".want-to-obey .count_sec")[0].querySelector("h2").textContent = "There is a reason why service dogs always form extraordinarily strong bonds with their human partners...";
    ...
    if (document.querySelector(".ten_week_bgr")) {
      document.querySelector(".ten_week_bgr").after(document.querySelectorAll(".after-refresh section.count_sec")[17]);
    ...
    document.querySelectorAll(".after-refresh section.count_sec")[3]?.insertAdjacentHTML(
      "beforebegin",
      `<div class="question_first_bgr"><div class="question_first_wrap"><h2>Have a question? Reach out to us or find some answers below</h2><ol class="question_accardion"></ol><button class="new_enroll_now_btn">Enroll Now - Lite Version <svg width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.23984 8.23356L4.47318 5.00023L1.23984 1.76689C0.914844 1.44189 0.914844 0.916894 1.23984 0.591895C1.56484 0.266895 2.08984 0.266895 2.41484 0.591895L6.23984 4.41689C6.56484 4.74189 6.56484 5.26689 6.23984 5.59189L2.41484 9.41689C2.08984 9.74189 1.56484 9.74189 1.23984 9.41689C0.923177 9.09189 0.914844 8.55856 1.23984 8.23356Z" fill="white"/>
                      </svg></button></div></div>`
    );

    document.querySelectorAll(".after-refresh section.count_sec")[24]?.insertAdjacentHTML(
      "afterend",
      `<div class="question_second_bgr"><div class="question_second_wrap"><h2>Our best customers are those who ask the most questions. Find answers below </h2><ol class="question_accardion"></ol><button class="new_enroll_now_btn">Enroll Now - Lite Version <svg width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.23984 8.23356L4.47318 5.00023L1.23984 1.76689C0.914844 1.44189 0.914844 0.916894 1.23984 0.591895C1.56484 0.266895 2.08984 0.266895 2.41484 0.591895L6.23984 4.41689C6.56484 4.74189 6.56484 5.26689 6.23984 5.59189L2.41484 9.41689C2.08984 9.74189 1.56484 9.74189 1.23984 9.41689C0.923177 9.09189 0.914844 8.55856 1.23984 8.23356Z" fill="white"/>
                      </svg></button></div></div>`
    );
    ...
    if (document.querySelector(".question_second_wrap .question_accardion")) {
      for (let key in arrQuestion) {
        document.querySelector(".question_second_wrap .question_accardion").insertAdjacentHTML("beforeend", setList(key, arrQuestion[key][0], arrQuestion[key][1], "questionSecond"));
      }
    }
    if (!document.querySelector(".mini_text_guarantee")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(3) .white-block > .enroll_now_lite")?.insertAdjacentHTML("afterend", `<div class="mini_text_guarantee"><span>Try risk-free with our unconditional 90-day money back guarantee</span></div>`);
    }
    document.querySelector(".after-refresh .count_sec:nth-of-type(6) .pattern-block .row1030 .col-md-12 > p:not(.sub_head_examples):nth-child(4)").innerHTML = `<span>Samantha Morgan</span><span>Plano, Texas</span>`;
    ...
    document.querySelector(".after-refresh .count_sec:nth-of-type(10) .content > .col-md-8 p:nth-child(5)").innerHTML = `<span>Barbara Wilson</span><span>Oakland, California</span>`;
    document.querySelector(".after-refresh .count_sec:nth-of-type(13) .content > .col-md-8 p:nth-child(4)").innerHTML = `<span>Jessica Kendricks</span><span>Buffalo, New York</span>`;
    document.querySelector(".after-refresh .count_sec:nth-of-type(15) .content > .col-md-8 p:nth-child(6)").innerHTML = `<span>Jennifer Aumand</span><span>Boca Raton, Florida</span>`;
    document.querySelector(".after-refresh .count_sec:nth-of-type(16) .row1030 > .col-md-12:not(.aftermasterclass) > p:nth-child(4)").innerHTML = `<span>Mark Amori</span><span>Sante Fe, New Mexico</span>`;
    document.querySelector(".after-refresh .count_sec:nth-of-type(22) .content > .col-md-6.col-sm-6:not(.dividing_line) > p:nth-child(4)").innerHTML = `<span>Jackie Stilson</span><span>Omaha, Nebraska</span>`;
    document.querySelector(".after-refresh .count_sec:nth-of-type(24) .quick_transcript > p:nth-child(2)").innerHTML = `<span>Ariel Summers</span><span>Phoenix, Arizona</span>`;
    ...
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(16) .new_enroll_now_btn")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(16) .row1030 > .col-md-12:not(.aftermasterclass) > p:nth-child(4)").insertAdjacentHTML(
        "afterend",
        `              <button class="new_enroll_now_btn">Enroll Now - Lite Version <svg width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.23984 8.23356L4.47318 5.00023L1.23984 1.76689C0.914844 1.44189 0.914844 0.916894 1.23984 0.591895C1.56484 0.266895 2.08984 0.266895 2.41484 0.591895L6.23984 4.41689C6.56484 4.74189 6.56484 5.26689 6.23984 5.59189L2.41484 9.41689C2.08984 9.74189 1.56484 9.74189 1.23984 9.41689C0.923177 9.09189 0.914844 8.55856 1.23984 8.23356Z" fill="white"/>
                        </svg></button>`
      );
    }
    ...
    document.querySelector(".after-refresh .count_sec:nth-of-type(21) img").src = "https://conversionratestore.github.io/projects/knineti/img/ASPCA_new.png";
    document.querySelectorAll(".after-refresh section.count_sec")[2].querySelector("h2").textContent = `Enroll for the masterclass today and get 3 bonus classes (worth US $209.10) free of charge:`;
    ...
    document.querySelectorAll(".after-refresh section.count_sec")[6].querySelector("h2").textContent = `ANY regular dog owner can achieve this kind of transformation… you don’t need a degree in animal behavior 🙂`;
    ...
    document.querySelectorAll(".after-refresh section.count_sec")[10].querySelector("h2").textContent = `Transform your dog from a leash-pulling nightmare into a zen master that’s a joy to walk with`;
    ...
    document.querySelectorAll(".after-refresh section.count_sec")[12].querySelector("h2").textContent = `Teach your pooch to stop barking and calmly say hello to other dogs and people`;
    ...
    document.querySelectorAll(".after-refresh section.count_sec")[18].querySelector("h2").textContent = `Transform your dog in as little as 10 to 15 minutes per day`;
    document.querySelectorAll(".after-refresh section.count_sec")[19].querySelector("h2").textContent = `Save up to $3,703 on dog training fees`;
    document.querySelectorAll(".after-refresh section.count_sec")[20].querySelector("h2").textContent = `Help us save rescue dogs’ lives`;
    document.querySelectorAll(".after-refresh section.count_sec")[21].querySelector("h2").textContent = `Get all your money back within 90 days if this isn’t right for you`;
    document.querySelectorAll(".after-refresh section.count_sec")[22].querySelector("h2").textContent = `Get your dog to listen to you even without treats`;
    document.querySelectorAll(".after-refresh section.count_sec")[23].querySelector("h2").textContent = `“...he listens to me all the time now...”`;
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(23) .new_block_without_treats")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(23) h2").insertAdjacentHTML("afterend", newBlockWithoutTreats);
    }
    ...
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(19) .new_block_transform")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(19) h2").insertAdjacentHTML("afterend", newBlockTransform);
    }
    ...
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(5)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(5)").setAttribute("data-visab", 4);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(6)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(6)").setAttribute("data-visab", 5);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(7)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(7)").setAttribute("data-visab", 6);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(8)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(8)").setAttribute("data-visab", 7);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(9)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(9)").setAttribute("data-visab", 8);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(10)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(10)").setAttribute("data-visab", 9);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(11)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(11)").setAttribute("data-visab", 10);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(12)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(12)").setAttribute("data-visab", 11);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(13)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(13)").setAttribute("data-visab", 12);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(14)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(14)").setAttribute("data-visab", 13);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(15)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(15)").setAttribute("data-visab", 14);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(16)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(16)").setAttribute("data-visab", 15);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(17)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(17)").setAttribute("data-visab", 16);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(18)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(18)").setAttribute("data-visab", 17);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(19)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(19)").setAttribute("data-visab", 18);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(20)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(20)").setAttribute("data-visab", 19);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(21)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(21)").setAttribute("data-visab", 20);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(22)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(22)").setAttribute("data-visab", 21);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(23)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(23)").setAttribute("data-visab", 22);
    }
    if (!document.querySelector(".after-refresh .count_sec:nth-of-type(24)").getAttribute("data-visab")) {
      document.querySelector(".after-refresh .count_sec:nth-of-type(24)").setAttribute("data-visab", 23);
    }
    if (window.innerWidth <= 768) {
      ...
      document.querySelector(".after-refresh .count_sec:nth-of-type(21) img").src = "https://conversionratestore.github.io/projects/knineti/img/ASPCA_new_mob.png";
    }
