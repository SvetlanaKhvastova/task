...
function newPage() {
  ...
  document
    ...
    .insertAdjacentHTML("afterbegin", firstBlock);
  ...
  setTimeout(() => {
    if (document.querySelector(".first_block")) {
      ...
      document.querySelectorAll("form")[0].action =
        `/enroll-process/` + window.location.search;

      document
        .querySelector(
          ".payment_inform_box .payment_inform_wrapp p.subtitle_text"
        )
        .after(document.querySelector(".customer_information_wrapper"));

      document
        .querySelectorAll(
          ".payment_inform_box .payment_inform_wrapp .customer_information_wrapper .row"
        )[1]
        .after(
      ...
      document
        .querySelector(".payment_inform_box .paymen_method p.subtitle_text")
        .after(document.querySelector(".paypament-details"));
      document
        .querySelector(".payment_inform_box .paymen_method p.subtitle_text")
        .after(document.querySelector(".card_type"));
      if (document.querySelector(".payment_inform_box .paypament-details")) {
        document
          .querySelectorAll(
            ".payment_inform_box .paymen_method .paypament-details .row"
          )[1]
          .after(
            document.querySelectorAll(
              ".payment_inform_box .paymen_method .paypament-details .row"
      ...
      setTimeout(() => {
        if (document.querySelector(".payment_inform_box .paypament-details")) {
          document
            .querySelector(".payment_inform_box")
            .after(
              document.querySelectorAll(
                ".payment_inform_box .paymen_method .paypament-details .row"
              )[5]
      ...
      document.querySelector(
        ".content .page h4, .content .entry-content h4"
   ...
   `
      ...
      let daySevenToday = new Date(new Date().setDate(new Date().getDate() + 7))
        .toDateString()
        .split(" ");
      let daySeven = new Date(
        new Date().setDate(new Date(dsp[0], dsp[1] - 1, dsp[2]).getDate() + 7)
      )
        .toDateString()
        .split(" ");
      document.querySelectorAll(
        ".scroll_bar_box li .text_block > div:last-child p"
      )[2].textContent = `${daySevenToday[1]} ${daySevenToday[2]}, ${daySevenToday[3]}`;
      document.querySelector(
        ".payment_inform_box li > div > p"
      ).textContent = `YOUR DISCOUNT IS VALID UNTIL ${daySeven[1]} ${daySeven[2]}, ${daySeven[3]}`;

      let dayThirty = new Date(new Date().setDate(new Date().getDate() + 30))
        .toDateString()
        .split(" ");
      document.querySelectorAll(
        ".scroll_bar_box li .text_block > div:last-child p"
      )[3].textContent = `${dayThirty[1]} ${dayThirty[2]}, ${dayThirty[3]}`;

      let dayNinty = new Date(new Date().setDate(new Date().getDate() + 90))
        .toDateString()
        .split(" ");
      document.querySelectorAll(
        ".scroll_bar_box li .text_block > div:last-child p"
      )[4].textContent = `Until ${dayNinty[1]} ${dayNinty[2]}, ${dayNinty[3]}`;
      ...
      document
        .querySelector("#selected-state-us")
      ...
      if (document.querySelector(".earlier_order_msz")) {
        document
          .querySelector("body .container .first_block > h1")
          .after(document.querySelector(".earlier_order_msz"));
      }

      if (document.querySelectorAll(".row .col-md-12")[7]) {
        document.querySelectorAll(".row .col-md-12")[7].style.textAlign =
          "left";
      }
  ...
  document
    .querySelector(".payment_inform_box .input_wrapper > div:last-child label")
