...
<style>
    ...
    .popup_second .body_popup button,
    .button_input_name,
    #contact-submit{
        background: #193973;
        border-radius: 10px;
...
<div class="popup_third">
    ...
    <div class="popup_adress">
        ...
        <div class="body_popup">
            <p>The workshop is conducted by Dr. Alexa Diaz PhD <br> (one of the foremost service dog trainers in the U.S.) and Eric Presnall <br> (host of the Animal Planet TV show "Who Let the Dogs Out").</p>
            <h2>Enter your email or phone number <br> to access this FREE online workshop <br> now</h2>
        </div>
    </div>
</div>
`
...
let buttonInputName = /*html*/ `
    <button class="button_input_name">Continue</button>
    <div class="benefits">
        <ul>
            <li>
                ...
                <p>This workshop helped train 2.7 million dogs</p>
            </li>
            <li>
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="security_box">
            ...
            <p>Your email address and phone number won't be shared with anyone. <br> Please review our privacy policy for more information.</p>
        </div>
    </div>
`
...
// document.querySelectorAll(".row-md-12.style-of-row-free-workshop")[0].insertAdjacentHTML("afterbegin", popup_second)
document.querySelectorAll(".row-md-12.style-of-row-free-workshop")[1].insertAdjacentHTML("afterbegin", popup_second)
document.querySelector("#finalForm").insertAdjacentHTML("afterbegin", popup_third)
document.querySelectorAll("form .form-group > div:last-child").forEach((el) => {
  el.insertAdjacentHTML("beforebegin", buttonInputName)
})
document.querySelector("#subs-name").placeholder = "Your name"
document.querySelector("#dog-name").placeholder = "Dog’s name"
document.querySelector("#subs-email").placeholder = "Enter your email"
document.querySelector("#subs-mobile").placeholder = "Enter your phone number"
document.querySelectorAll("#contact-submit").forEach((el) => {
  el.textContent = "Get workshop link"
})

document.querySelectorAll("#contact-submit").forEach((el) => {
  el.value = "Get workshop link"
})
...
if (document.querySelector(".vis-ver-0_0.modal-header.modal-header-style.modal-of-header.style-border.modal-header1")) {
  document.querySelector(".vis-ver-0_0.modal-header.modal-header-style.modal-of-header.style-border.modal-header1").insertAdjacentHTML("beforebegin", popup_first)

  document.querySelector(".popup_first .btn_wrapp > div a:first-child").addEventListener("click", function (e) {
    e.preventDefault()
    document.querySelector(".sec .puppy-popup-link #puppyCheck").click()
    document.querySelector(".popup_first").style.display = "none"
    document.querySelector(".popup_second").style.display = "block"
    console.log(`button1`)
  })
...
if (document.querySelector(".popup_second .body_popup button")) {
  document.querySelector(".popup_second .body_popup button").addEventListener("click", function () {
    document.querySelector("#puppyContent .yesno .ysn.popup_link:nth-child(1) a").click()
    document.querySelector(".popup_second").style.display = "none"
    document.querySelector(".popup_third").style.display = "block"
  })
}

document.querySelector(".popup_second .body_popup .show_more").addEventListener("click", () => {
  document.querySelector(".second_block_checkbox").style.display = "flex"
  document.querySelector(".popup_second .body_popup .show_more").style.display = "none"
})

document.querySelectorAll(".button_input_name").forEach((el) => {
  el.addEventListener("click", () => {
    el.style.display = "none"
    document.querySelectorAll("#subs-name").forEach((el) => {
      el.style.display = "none"
    })
    document.querySelectorAll("#dog-name").forEach((el) => {
      el.style.display = "none"
    })
    document.querySelectorAll("#subs-email").forEach((el) => {
      el.style.display = "flex"
    })
    document.querySelectorAll("#subs-mobile").forEach((el) => {
      el.style.display = "flex"
    })
    document.querySelectorAll("#contact-submit").forEach((el) => {
      el.style.display = "flex"
    ...
    document.querySelector(".popup_adress").style.display = "block"
    document.querySelector(".popup_name").style.display = "none"
  })
})
