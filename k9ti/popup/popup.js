...
#adultContent .first_block_checkbox input.custom_checkbox,
#adultContent .second_block_checkbox input.custom_checkbox,
#puppyContent .first_block_checkbox input.custom_checkbox,
#puppyContent .second_block_checkbox input.custom_checkbox {
  position: absolute;
  z-index: -1;
  opacity: 0;
}

#puppyContent .first_block_checkbox label,
#puppyContent .second_block_checkbox label,
#adultContent .first_block_checkbox label,
#adultContent .second_block_checkbox label {
  width: 48%;
...
#puppyContent .custom_checkbox + label::before,
#adultContent .custom_checkbox + label::before  {
  content: "";
...
#puppyContent .custom_checkbox:checked + label::before,
#adultContent .custom_checkbox:checked + label::before {
...
let buttonInputName = /*html*/ `
    <div class="button_input_name">Continue</div>
    <div class="benefits">
        <ul>
            <li>
...
if (document.querySelector("#firstModal .vis-ver-0_0.modal-header.modal-header-style.modal-of-header.style-border.modal-header1")) {
  ...
  document.querySelector("#firstModal #puppyContent .popup_second .body_popup .show_more").addEventListener("click", () => {
    console.log(`#puppyContent show_more`)
  ...
  document.querySelector("#firstModal #adultContent .popup_second .body_popup .show_more").addEventListener("click", () => {
    console.log(`#adultContent show_more`)
