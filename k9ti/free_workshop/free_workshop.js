...
<div class="price_block">
    ...
    <div>
        <p>Get Total Transformation Masterclass and FREE gifts now </p>
        <div></div>
        <div>
        ...
        <p>Your special offer will be available in 35:00</p>
    </div>
</div>
`
...
document.querySelector(".free_work_shop_box").insertAdjacentHTML("afterend", priceBlock)
