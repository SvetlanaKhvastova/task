...
<div class="compatibility_block ${classess}">
  ...
  function qtyChange(event) {
    ...
    if (pr && compare && stickyPr && stickyCompare) {
  ...
  function redesignPacks() {
    ...
    document.querySelectorAll(".product__alternates .alternative-options > li").forEach((item, index) => {
      ...
      document.querySelector(".pack_size ul").insertAdjacentHTML(
        "beforeend",
        `
          ...
          getCart().then((data) => {
            if (data.items.length > 0) {
              ...
              if (document.querySelector(".cart-drawer__items") && !document.querySelector(".subtotal-wrapper")) {
                ...
                document.querySelector(".cart-drawer__items").insertAdjacentHTML("afterend", `<div class="subtotal-wrapper">${subtotalHTML}</div>`);
              } else {
  ...
  function redesignCartMsg() {
    ...
    if (!document.querySelector(".away-from")) {
      ...
      document.querySelector(".cart__message__progress__holder").insertAdjacentHTML(
        "beforebegin",
        /*html*/ `
      ...
      if (document.body) {
        ...
        if (location.href.includes("/products/")) {
          ...
          const waitForSlider = setInterval(() => {
            if (document.querySelector(".product__title-and-price") && document.querySelector(".product__reviews")) {
              ...
              const waitForFlickity = setInterval(() => {
                if (typeof Flickity === "function") {
                  ...
                  if (media) {
                    ...
                    let slider = new Flickity(document.querySelector(".product-single__thumbnails"), {
                      // (3)
                      contain: true,
                      pageDots: true,
                      auto: true,
                    ...
                    let slider = new Flickity(document.querySelector(".product-single__media-slider"), {
                      // (3)
                      contain: true,
                      pageDots: false,
                      auto: true,
                    ...
                    let slider1 = new Flickity(document.querySelector(".product-single__thumbnails"), {
                      // (3)
                      contain: true,
                      pageDots: false,
                      auto: true,
              ...
              document.querySelector(".product__reviews").insertAdjacentHTML(
                "beforeend",
                /*html*/ `
...
<a href="#shopify-section-template--16711182876924__16842542196ee361cd">See all reviews</a>
          ...
          const waitForDelivery = setInterval(() => {
            if (document.querySelector(".product__accordions .product__accordion__content p") && document.querySelector(".product__form__wrapper")) {
              ...
              document.querySelector(".product__form__wrapper").insertAdjacentHTML(
                "afterend",
                `
                <div class="delivery">
          ...
          const waitForDetailsSection = setInterval(() => {
            if (document.querySelector(".product__description")) {
              ...
              document.querySelector(".product__description").insertAdjacentHTML(
                "afterbegin",
                `
              ...
              <p class="title title_about">About this product</p>`
                ...
                waitForElement(".btn_more").then((btn) => {
                  handleVisibility(btn, ["exp_imp_pdp_v_dlm_ft", "{{focusTime}}", "Visibility", "Details learn more"]);
          ...
          const waitForLiftUpIcons = setInterval(() => {
            if (document.querySelector("#shopify-section-template--16711182876924__icons") && !document.querySelector(".shopify-section--product+#shopify-section-template--16711182876924__icons")) {
          ...
          waitForElement(".product-single__thumbnails").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_vis_fs_t", "{{focusTime}}", "Visibility", "First sccreen Thumbnail"]);
          });
          waitForElement(".manufacturer").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_fs_dfm", "{{focusTime}}", "Visibility", "First sccreen Direct from the manufacturer"]);
          });
          waitForElement(".pack_size").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_ps_pss", "{{focusTime}}", "Visibility", "Pack size Pack size section"]);
          });
          waitForElement(".qty_block").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_ps_1p", "{{focusTime}}", "Visibility", "Pack save 1 pack"]);
          });
          waitForElement(".discount").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_ps_s", "{{focusTime}}", "Visibility", "Pack save spend"]);
          });
          waitForElement(".delivery").then((el) => handleVisibility(el, ["exp_imp_pdp_v_dr_ft", "{{focusTime}}", "Visibility", "Delivery & Return"]));
          waitForElement(".btn_more").then((el) => handleVisibility(el, ["exp_imp_pdp_v_drlm_ft", "{{focusTime}}", "Visibility", "Delivery & Return learn more"]));
          waitForElement(".warranty").then((el) => handleVisibility(el, ["exp_imp_pdp_v_365_ft", "{{focusTime}}", "Visibility", "365 day warranty"]));
          ...
          waitForElement(".product__block .title + p").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_d_ft", "{{focusTime}}", "Visibility", "Details"]);
          });
          waitForElement(".support").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_q_ft", "{{focusTime}}", "Visibility", "Questions"]);
          });
          ...
          waitForElement(".icons-row").then((el) => handleVisibility(el, ["exp_imp_pdp_v_b_ft", "{{focusTime}}", "Visibility", "Benefits"]));
          waitForElement(".featured-collection__container .product-grid-item").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_ymal_ft", "{{focusTime}}", "Visibility", "You may also like"]);
          });
          waitForElement(".related-products .product-grid-item").then((el) => {
            handleVisibility(el, ["exp_imp_pdp_v_rv_ft", "{{focusTime}}", "Visibility", "Recently viewed"]);
          });
          waitForElement(".product-single__thumbnails").then((el) => {
          ...
          waitForElement(".featured-collection__container .carousel").then((el) => {
            ...
            el.addEventListener("scroll", function () {
              if (!scrolled) {
                pushDataLayer(["exp_imp_pdp_s_ymal_h", "Horisontal", "Scrool", "You may also like"]);
