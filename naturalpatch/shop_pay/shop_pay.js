let startFuncShopPay = setInterval(() => {
  if (document) {
    ...
    .weeks_months_box{
      ...
      background: #FFF;
      box-shadow: 0px 12px 32px 0px rgba(0, 0, 0, 0.05), 0px 2px 4px 0px rgba(12, 11, 11, 0.10);
      padding: 16px;
    }
    .weeks_block{
      margin-bottom: 16px;
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="26" viewBox="0 0 24 26" fill="none">
            <g clip-path="url(#clip0_95_1416)">
              ...
              <g mask="url(#mask0_95_1416)">
                <path d="M0.509766 13.0001C0.509766 6.65147 5.65635 1.50488 12.005 1.50488C18.3536 1.50488 23.5002 6.65147 23.5002 13.0001C23.5002 19.3487 18.3536 24.4953 12.005 24.4953C5.65635 24.4953 0.509766 19.3487 0.509766 13.0001Z" fill="#FF3C81" stroke="white" stroke-width="0.999583"/>
  ...
  `;
    ...
    function renderNewElem() {
      ...
      switch (window.location.pathname) {
        case "/products/buzzpatch-bundles":
          styleBtn = "buzzpatch_var";
          break;
        case "/products/zenpatch-mood-calming-stickers":
          styleBtn = "zenpatch_var";
          break;
        case "/products/sleepypatch-sleep-promoting-stickers":
      ...
      if (window.location.pathname.match("/products/buzzpatch-bundles") || window.location.pathname.match("/products/zenpatch-mood-calming-stickers") || window.location.pathname.match("/products/sleepypatch-sleep-promoting-stickers")) {
        ...
        <div class="instal_info_txt">
          4 interest-free instalments, or from <span class="currency_txt">${currency}</span><span class="price_from_month">${priceFromMonth.toFixed(2)}</span>/mo with
      ...
      <div class="content_popup">
        ...
        <p class="sample_plans_txt">Sample plans for <span>${currency}${priceItem.toFixed(2)}</span> purchase</p>
        ...
        <div class="weeks_months_box">
          <div class="weeks_block">
            <div class="weeks_months_header">
              <span>${currency}${priceItemWeek.toFixed(2)} / 2 weeks</span>
              <span>8 weeks</span>
            </div>
            <div class="weeks_months_body">
              ...
              <div class="weeks_months_bottom">
                <span>0%</span>
                <span>$0.00</span>
                <span>${currency}${priceItem.toFixed(2)}</span>
              </div>
            </div>
          </div>
          <div class="months_block">
            <div class="weeks_months_header">
              <span>${currency}${priceFromMonth.toFixed(2)} / month</span>
              <span>12 months</span>
            </div>
            <div class="weeks_months_body">
                <div class="weeks_months_top">
                ...
                <div class="weeks_months_bottom">
                  <span>15%</span>
                  <span>${currency}${interestMonths.toFixed(2)}</span>
                  <span>${currency}${Math.round10(totalMonths, -1).toFixed(2)}</span>
                </div>
            </div>
          </div>
        </div>
