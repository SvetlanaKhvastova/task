...
<style>
    ...
    *::after {
    ...
    .third-block {
        margin: 187px 0 217px;
    } 

    .fourth-block {
        margin: 233px 0 263px;
    }
    ...
    .quiz-link-img:first-child,
    .quiz-link-img:last-child {
        border: 1px solid #DA3269;
        border-radius: 3px;
    }
    ...
    */
    ...
    .article-hover {
        ...
        background: #FFFFFF;
        filter: drop-shadow(-1px 2px 1px rgba(0, 0, 0, 0.02)) drop-shadow(-10px 15px 90px rgba(0, 0, 0, 0.1));
        border-radius: 2px;
...
let quiz = /*html*/ `
    ...
    <section class="section-fourth">
        ...
        <div class="fourth-block">
            <h2 class="quiz-title quiz-title-fourth">Do you have pets?</h2>
            <div class="label-flex">
                <div class="label-box">
                    <label class="label-position">
                        <input type="radio" name="variant" checked class="radio-box">
                ...
                <div class="label-box">
                    <label class="label-position">
                        <input type="radio" name="variant" class="radio-box">
                        <span class="radio-style"></span>
                        No
                    </label>
                </div>
    ...
    <section class="section-sixth">
        ...
        <div class="sixth-block">
            <h2 class="quiz-title title-sixth title-sixth-desktop">Enter your email below to <span class="title-sixth-bold">receive an exclusive</span> <br> <span class="title-sixth-bold">$10 discount</span> on your next purchase</h2>
            <h2 class="quiz-title title-sixth title-sixth-mobile">Enter your email below to <span class="title-sixth-bold">receive an exclusive</span><span class="title-sixth-bold">$10 discount</span> on your next purchase</h2>
            <label class="section-six-label">
    ...
    <section class="section-result">
        ...
        <div class="result-wrapper">
            <div class="result-img-box">
                <img src="./img/result.jpg" alt="foto" width="345" class="result-photo">
                <ul class="none-marker result-slider">
                    <li class="result-slider-link"><img src="./img/result.jpg" alt="" width="35"></li>
                    <li class="result-slider-link"><img src="./img/result.jpg" alt="" width="35"></li>
                    <li class="result-slider-link"><img src="./img/result.jpg" alt="" width="35"></li>
                    <li class="result-slider-link"><img src="./img/result.jpg" alt="" width="35"></li>
                    <li class="result-slider-link"><img src="./img/result.jpg" alt="" width="35"></li>
            ...
            <div class="result-text-box">
                <h3 class="result-text-box-title">Recliner slipover MICROFIBRA COLLECTION</h3>
                <span class="result-size">69”-91’ wide</span>
                <div>
                    <p class="result-text-box-color">Color:
                        <span class="result-color-accent">Blue</span>
                    </p>
                    <div>
                        <button type="button" class="controls-color-btn"></button>
                        <button type="button" class="controls-color-btn"></button>
                        <button type="button" class="controls-color-btn"></button>
                        <button type="button" class="controls-color-btn"></button>
                        <button type="button" class="controls-color-btn"></button>
