let startFunk = setInterval(() => {
    if (document.querySelector('.main_header')) {
        ...
        <style>
            ...
            .cart_popup__footer form{
                display: flex;
                flex-direction: column;
            }
            .cart_popup__footer form label{
                display: flex;
                flex-direction: column;
                font-weight: 400;
                font-size: 15px;
            ...
            .cart_popup__footer form label textarea{
                width: 100%;
                resize: both;
                min-height: 50px;
                max-height: 230px;
        ...
        let popUp = /*html */ `
            <div class="popup_slide_in is_hidden" data-modal>
                <div class="container_popup">
                    ...
                    <div class="cart_popup__scroll">
                        <div class="product_wrap">
                            <div class="img_wrap">
                            <img src="https://conversionratestore.github.io/projects/themillionroses/img/test.jpg" alt="" />
                            </div>
                            <div class="inform_wrap">
                            <h2>Heart Black Box | 24K Gold & Red Roses</h2>
