...
document.querySelector("#fullWidth").remove()
document.querySelector(".sandbox-header").remove()
document.querySelector(".ng-scope").insertAdjacentHTML(
  "afterbegin",
  `
    <div class="landing-wrap">
        <section class="s-first">
          <div class="container"><img class="logo" src="https://conversionratestore.github.io/projects/samcart/img/logo.svg">
            ...
            <div class="webinar"><img class="avatar" src="https://conversionratestore.github.io/projects/samcart/img/photo_speaker.jpg" alt="avatar">
        ...
        <section class="s-second">
          <div class="container">
            ...
            <div class="flex-wrap d-flex">
              <div class="card">
                <div class="card-top"><img class="card-img" src="https://conversionratestore.github.io/projects/samcart/img/expert.svg">
                  <p><b>Become a trusted expert</b> in a niche using the "1 Step Rule"</p>
                  ${createlistInfo("How to get people to listen to you", "Discover what to make your course about", "The secret to creating a course people want to buy ")}
                </div>
                <button class="btn-blue" type="button" data-button="expert">Discover how to<img src="https://conversionratestore.github.io/projects/samcart/img/arrow-white.svg"></button>
              </div>
              <div class="card">
                <div class="card-top"><img class="card-img" src="https://conversionratestore.github.io/projects/samcart/img/sales.svg">
              ...
              <div class="card">
                <div class="card-top"><img class="card-img" src="https://conversionratestore.github.io/projects/samcart/img/bar-chart.svg">
                  <p><b>Get</b> (virtually)<b> unlimited</b> traffic from today's #1 traffic source</p>
                   ${createlistInfo(
                     "How to get more people to your course page",
                     "Generate dozens of new sales every day",
                     `Secret tool to ethically ‘steal’ your competitors' ads`
                   )}
                </div>
                <button class="btn-blue" type="button" data-button="bar-chart">Discover how to<img src="https://conversionratestore.github.io/projects/samcart/img/arrow-white.svg"></button>
              </div>
              <div class="card">
                <div class="card-top"><img class="card-img" src="https://conversionratestore.github.io/projects/samcart/img/much-more.svg">
                  <p><b>Launch in 7 days</b> (from scratch) without a team or complicated tech</p>
                   ${createlistInfo(
                     `The secret to building the "laptop lifestyle"`,
                     `Simplify your sales process for better results`,
                     `Rapidly increase your conversions, sales, and revenue`
                   )}
                </div>
                <button class="btn-blue" type="button" data-button="much-more">Discover how to<img src="https://conversionratestore.github.io/projects/samcart/img/arrow-white.svg"></button>
              </div>
            </div>
          </div>
        </section>
...
btn.forEach((btn) => {
  btn.addEventListener("click", (e) => {
      ...
      if (emailValue != "" && patternEmail.test(emailValue)) {
        if (detectMob() == true) {
          document.querySelector(".popup .content").innerHTML =
            createElementFirst + creatBlock("lamp", "Indicate your current sales below to let us customize the onboarding process for you.", "small")
        } else {
          document.querySelector(".popup .content").innerHTML =
            createElementFirst + creatBlock("lamp", "Indicate your current sales on the right to let us customize the onboarding process for you.", "small")
        }
    ...
    if (getAttr == "much-more" && btn.closest(".card")) {
      dataLayerPush("Click on Discover how to button", "Launch in 7 days")
      dataLayerPush("View popup", "Popup: Save Your Spot (Launch in 7 days)")
      document.querySelector(".popup .content").innerHTML =
        creatBlock("much-more", "Launch in 7 days (from scratch) without a team or complicated tech") +
        createlistInfo('The secret to building the "laptop lifestyle"', "Simplify your sales process for better results", "Rapidly increase your conversions, sales, and revenue")
      ...
      dataLayerPush("Click on Discover how to button", "Get (virtually) unlimited traffic")
      dataLayerPush("View popup", "Popup: Save Your Spot (Get (virtually) unlimited traffic)")
      document.querySelector(".popup .content").innerHTML =
        creatBlock("bar-chart", `Get (virtually) unlimited traffic from today's #1 traffic source`) +
        createlistInfo("How to get more people to your course page", "Generate dozens of new sales every day", `Secret tool to ethically steal your competitors' ads`)
      ...
      dataLayerPush("Click on Discover how to button", "Generate sales around the clock")
      dataLayerPush("View popup", "Popup: Save Your Spot (Generate sales around the clock)")
      document.querySelector(".popup .content").innerHTML =
        creatBlock("sales", 'Generate sales around the clock using a simple "1 page funnel"') +
        createlistInfo("Convince anyone to buy your product", "Best way to start your online business", "Core 4 elements your page needs to sell")
      ...
      dataLayerPush("Click on Discover how to button", "Become a trusted expert")
      dataLayerPush("View popup", "Popup: Save Your Spot (Become a trusted expert)")
      document.querySelector(".popup .content").innerHTML =
        creatBlock("expert", 'Become a trusted expert in a niche using the "1 Step Rule"') +
        createlistInfo("How to get people to listen to you", "Discover what to make your course about", "The secret to creating a course people want to buy")
...
//   <img width="1024" height="176" src="https://try.samcart.com/wp-content/uploads/2019/10/original_logo_white-1024x176.png" class="attachment-large size-large" alt="SamCart company logo in white" loading="lazy" srcset="https://try.samcart.com/wp-content/uploads/2019/10/original_logo_white-1024x176.png 1024w, https://try.samcart.com/wp-content/uploads/2019/10/original_logo_white-300x52.png 300w, https://try.samcart.com/wp-content/uploads/2019/10/original_logo_white-768x132.png 768w, https://try.samcart.com/wp-content/uploads/2019/10/original_logo_white.png 1106w" sizes="(max-width: 1024px) 100vw, 1024px">
//   </div>
//   <div class="elementor-element elementor-element-11c6e17 elementor-widget elementor-widget-text-editor" data-id="11c6e17" data-element_type="widget" data-widget_type="text-editor.default">
// 				<div class="elementor-widget-container">
// 					<div class="elementor-text-editor elementor-clearfix"><div><a id="link-638-440" class="" href="https://www.samcart.com/" target="_blank" rel="noopener noreferrer">Home</a>&nbsp;–&nbsp;<a id="link-2915-61" class="" href="https://www.brianmoran.com/privacy/" target="_blank" rel="noopener noreferrer">Privacy Policy</a>&nbsp;–&nbsp;<a id="link-4896-141" class="" href="https://www.brianmoran.com/terms-conditions/" target="_blank" rel="noopener noreferrer">Terms</a></div><div>SamCart.com – COPYRIGHT @ 2018 – ALL RIGHTS RESERVED –</div><div>11850 West Market Place, Suite C, Fulton, MD 20759</div></div>
// 				</div>
// 				</div>
//     <div class="elementor-element elementor-element-f63a9c4 elementor-shape-circle e-grid-align-center elementor-grid-0 e-grid-align-center elementor-widget elementor-widget-social-icons" data-id="f63a9c4" data-element_type="widget" data-widget_type="social-icons.default">
// 				<div class="elementor-widget-container">
// 					<div class="elementor-social-icons-wrapper elementor-grid">
// 							<div class="elementor-grid-item">
// 					<a class="elementor-icon elementor-social-icon elementor-social-icon-facebook-f elementor-animation-grow elementor-repeater-item-4cd9d92" href="https://www.facebook.com/samcartapp/" target="_blank">
// 						<span class="elementor-screen-only">Facebook-f</span>
// 						<i class="fab fa-facebook-f"></i>					</a>
// 				</div>
// 							<div class="elementor-grid-item">
// 					<a class="elementor-icon elementor-social-icon elementor-social-icon-youtube elementor-animation-grow elementor-repeater-item-b582169" href="https://www.youtube.com/user/samcartapp" target="_blank">
// 						<span class="elementor-screen-only">Youtube</span>
// 						<i class="fab fa-youtube"></i>					</a>
// 				</div>
// 							<div class="elementor-grid-item">
// 					<a class="elementor-icon elementor-social-icon elementor-social-icon-itunes-note elementor-animation-grow elementor-repeater-item-7f63e13" href="https://itunes.apple.com/us/podcast/5-minute-marketing-shortcuts/id1099540724?mt=2" target="_blank">
