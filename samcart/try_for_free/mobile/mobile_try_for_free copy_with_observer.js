...
<style>
  ...
  .absolute_box p span .mini_box.toggle_opacity, p.total_text span .mini_box.toggle_opacity, p.hint_plan span .mini_box.toggle_opacity,
  .absolute_box p span .hidden_text.toggle_opacity, p.total_text > span .hidden_text.toggle_opacity, p.hint_plan > span .hidden_text.toggle_opacity {
    opacity: 1;
  }
        ...
        <p>
          ...
          <span>
            <svg class="hint" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M1.5 9C1.5 4.86 4.85999 1.5 9 1.5C13.14 1.5 16.5 4.86 16.5 9C16.5 13.14 13.14 16.5 9 16.5C4.85999 16.5 1.5 13.14 1.5 9ZM3 9C3 12.3075 5.69247 15 9 15C12.3075 15 15 12.3075 15 9C15 5.6925 12.3075 3 9 3C5.69247 3 3 5.6925 3 9Z" fill="#98B9E9"/>
            </svg>
          ...
          Your plan will start after the end of Free Trial
            <span>
              <svg class="hint" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.5 9C1.5 4.86 4.85999 1.5 9 1.5C13.14 1.5 16.5 4.86 16.5 9C16.5 13.14 13.14 16.5 9 16.5C4.85999 16.5 1.5 13.14 1.5 9ZM3 9C3 12.3075 5.69247 15 9 15C12.3075 15 15 12.3075 15 9C15 5.6925 12.3075 3 9 3C5.69247 3 3 5.6925 3 9Z" fill="white"/>
              </svg>
              ...
              <span class="hidden_text"
                >Our templates can help you start your new online business within days. If you decide that you are not yet ready to create your new marketplace, simply cancel your risk-free trial within 14 days and we will not charge you anything.</span
              >
            </span>
  </p>`
