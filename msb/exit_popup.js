(() => {
  ...
  const blockVisibility = (selector, event, descr, location) => {
    ...
    let v2 = new IntersectionObserver((entries) => {
      entries.forEach((item) => {
        if (item.isIntersecting) {
          pushDataLayer(event || `view_element_${item.target.id}`, descr || "Element visibility", "Visibility", location || item.target.id);
          v1.unobserve(item.target);
        } else {
  ...
  const icons = {
    ...
    copied: /* HTML */ `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 0C5.388 0 0 5.388 0 12C0 18.612 5.388 24 12 24C18.612 24 24 18.612 24 12C24 5.388 18.612 0 12 0ZM17.736 9.24L10.932 16.044C10.764 16.212 10.536 16.308 10.296 16.308C10.056 16.308 9.828 16.212 9.66 16.044L6.264 12.648C5.916 12.3 5.916 11.724 6.264 11.376C6.612 11.028 7.188 11.028 7.536 11.376L10.296 14.136L16.464 7.968C16.812 7.62 17.388 7.62 17.736 7.968C18.084 8.316 18.084 8.88 17.736 9.24Z" fill="#A11A17" />
    </svg>`,
    fire: /* HTML */ `<svg xmlns="http://www.w3.org/2000/svg" width="13" height="15" viewBox="0 0 13 15" fill="none">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M6.23567 15C4.68405 14.7621 3.36202 13.4342 4.00238 10.6157C4.65097 11.5561 4.88682 11.0593 4.88682 11.0593C4.92613 7.86523 7.34365 7.0667 7.34365 7.0667C6.62025 8.69947 8.05176 8.74459 8.14948 10.5979C8.73914 10.2962 8.95534 9.95911 8.95534 9.95911C10.9077 12.5842 9.46019 14.4626 7.61331 14.9445C10.5714 14.565 13.1147 12.0602 11.8966 6.69877C10.6723 8.47396 10.2271 7.53616 10.2271 7.53616C10.1529 1.50726 5.58978 0 5.58978 0C6.95527 3.08196 4.25318 3.16708 4.06868 6.66531C2.95571 6.09589 2.54764 5.45951 2.54764 5.45951C-1.53773 10.9528 2.26352 14.7142 6.23567 15Z" fill="#A11A17" />
    </svg>`,
    warranty: /* HTML */ ` <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
      <g clip-path="url(#clip0_197_63534)">
        <path d="M24.1 12.5C24.1 11.3 22.7 10.3 22.4 9.29999C22 8.19999 22.6 6.59999 21.9 5.69999C21.2 4.79999 19.6 4.79999 18.6 4.09999C17.7 3.39999 17.2 1.79999 16.1 1.49999C15 1.09999 13.7 1.99999 12.5 1.99999C11.3 1.99999 10 0.999986 8.90002 1.39999C7.80002 1.79999 7.30002 3.39999 6.40002 3.99999C5.40002 4.69999 3.80002 4.69999 3.10002 5.69999C2.40002 6.59999 2.90002 8.19999 2.60002 9.29999C2.30002 10.4 0.900024 11.3 0.900024 12.5C0.900024 13.7 2.30002 14.7 2.60002 15.7C3.00002 16.8 2.40002 18.4 3.10002 19.3C3.80002 20.2 5.40002 20.2 6.40002 20.9C7.30002 21.6 7.80002 23.2 8.90002 23.5C10 23.8 11.3 22.9 12.5 22.9C13.7 22.9 15 23.9 16.1 23.5C17.2 23.1 17.7 21.6 18.6 20.9C19.5 20.2 21.2 20.2 21.9 19.3C22.6 18.4 22.1 16.8 22.4 15.7C22.8 14.7 24.1 13.7 24.1 12.5ZM12.5 21.5C7.50002 21.5 3.50002 17.5 3.50002 12.5C3.50002 7.49999 7.50002 3.49999 12.5 3.49999C17.5 3.49999 21.5 7.49999 21.5 12.5C21.5 17.5 17.5 21.5 12.5 21.5Z" fill="#B68B52" />
        <path d="M18.2 6.80002C16.7 5.30002 14.7 4.40002 12.5 4.40002C10.3 4.40002 8.30002 5.30002 6.80002 6.80002C5.30002 8.30002 4.40002 10.3 4.40002 12.5C4.40002 14.7 5.20002 16.7 6.80002 18.2C8.30002 19.7 10.3 20.6 12.5 20.6C14.7 20.6 16.7 19.8 18.2 18.2C19.7 16.7 20.6 14.7 20.6 12.5C20.6 10.3 19.7 8.30002 18.2 6.80002Z" fill="#B68B52" />
        <path d="M8.00007 15.0999V14.3999C8.80007 13.7999 9.40007 13.2999 9.90007 12.8999C10.6001 12.2999 10.7001 11.8999 10.7001 11.4999C10.7001 10.9999 10.3001 10.5999 9.70007 10.5999C9.10007 10.5999 8.60007 11.0999 8.70007 11.7999H7.80007C7.70007 10.6999 8.40007 9.79993 9.70007 9.79993C10.9001 9.79993 11.6001 10.5999 11.6001 11.4999C11.6001 11.9999 11.4001 12.5999 10.8001 13.1999C10.5001 13.5999 10.0001 13.8999 9.30007 14.3999H11.7001V15.1999H8.00007V15.0999Z" fill="white" />
        <path d="M13.6001 9.8999H16.9001V10.6999H14.3001L14.2001 11.8999C14.5001 11.6999 14.9001 11.4999 15.3001 11.4999C16.2001 11.4999 17.1001 12.1999 17.1001 13.2999C17.1001 14.3999 16.2001 15.1999 15.1001 15.1999C14.0001 15.1999 13.4001 14.5999 13.1001 13.9999L13.9001 13.6999C14.1001 14.0999 14.5001 14.3999 15.0001 14.3999C15.7001 14.3999 16.1001 13.8999 16.1001 13.2999C16.1001 12.6999 15.6001 12.1999 15.0001 12.1999C14.6001 12.1999 14.3001 12.3999 14.0001 12.5999L13.2001 12.3999L13.6001 9.8999Z" fill="white" />
      </g>
      <defs>
    ...
    return: /* HTML */ `<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
      <path d="M17.0759 0H1.84388C0.801688 0 0 0.881857 0 1.92405V17.0759C0 18.1181 0.881856 19 1.92405 19H17.0759C18.1181 19 19 18.1181 19 17.0759V1.92405C18.9198 0.881857 18.1181 0 17.0759 0ZM9.45992 15.7131C6.73418 15.7131 4.48945 13.4684 4.48945 10.7426H5.69198C5.69198 12.827 7.37553 14.4304 9.37975 14.4304C11.4641 14.4304 13.0675 12.7468 13.0675 10.7426C13.0675 8.65823 11.384 7.05485 9.37975 7.05485V9.54008L6.4135 6.4135L9.54009 3.28692V5.77215C12.2658 5.77215 14.5105 8.01688 14.5105 10.7426C14.4304 13.4684 12.1857 15.7131 9.45992 15.7131Z" fill="#B68B52" />
    </svg>`,
    close: /* HTML */ `<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
      <path d="M1.67181 2L11 11.3M1.67181 11.3L11 2" stroke="#333333" stroke-width="2.325" stroke-linecap="round" stroke-linejoin="round" />
    </svg>`,
  };
  ...
  class ExitPopup {
    constructor() {
      ...
      this.country = window.location.host.includes("au") ? "AU" : window.location.host.includes("us") ? "US" : window.location.host.includes("ca") ? "CA" : "UK";
    ...
    async firstOrderDiscountPopup() {
      ...
      if (enhanceExpiriencePopup) {
        ...
        const popupMutationObserver = new MutationObserver((mutations) => {
          mutations.forEach((mutation) => {
            ...
            if (enhanceForm && enhanceForm.dataset.hidden !== "not-hidden") {
                ...
                <div class="crs-promo-form">
                  <div class="crs-promo-form__content">
                    ...
                    ${this.country === "UK"
                      ...
                      : /* HTML */ `<p class="crs-promo-form__descr">Your 10% first order discount is ready (no minimum spend, no exclusions).</p>`}
                    ${this.promoCode()}
              ...
              if (this.country === "UK") {
                blockVisibility(".crs-promo-form", "exp_pop_car_retent_vis_youlisuk_view", "Pop up view", "Pop up You are on the list UK");
                closeBtnEvent = (e) => {
                  pushDataLayer("exp_pop_car_retent_but_youlisuk_clos", "Close", "Button", "Pop up You are on the list UK");
                };
                $el('div[role="dialog"] .klaviyo-close-form').removeEventListener("click", closeBtnEvent);
                $el('div[role="dialog"] .klaviyo-close-form').addEventListener("click", closeBtnEvent);
              } else {
                blockVisibility(".crs-promo-form", "exp_pop_car_retent_vis_youlisuca_view", "Pop up view", "Pop up You are on the list USA, Canada, Australia");
                closeBtnEvent = (e) => {
                  pushDataLayer("exp_pop_car_retent_but_youlisuca_clos", "Close", "Button", "Pop up You are on the list USA, Canada, Australia");
                };
                $el('div[role="dialog"] .klaviyo-close-form').removeEventListener("click", closeBtnEvent);
                $el('div[role="dialog"] .klaviyo-close-form').addEventListener("click", closeBtnEvent);
              }
        ...
        waitForElement(selector).then((elem) => {
          if (this.country === "UK") {
            blockVisibility(selector, "exp_pop_car_retent_vis_fredeluk_view", "Pop up view", "Pop up Get 10% Off plus Free Next-Day UK Delivery! UK");
            closeBtnEvent = (e) => {
              pushDataLayer("exp_pop_car_retent_but_fredeluk_clos", "Close", "Button", "Pop up Get 10% Off plus Free Next-Day UK Delivery! UK");
            };
            closeByClickOutsideEvent = (e) => {
              if (e.target.closest('div[role="dialog"]')) return;
              pushDataLayer("exp_pop_car_retent_backd_fredeluk_clos", "Close", "Button", "Pop up Get 10% Off plus Free Next-Day UK Delivery! UK");
            };
            $el('div[role="dialog"] .klaviyo-close-form').removeEventListener("click", closeBtnEvent);
            $el('div[role="dialog"] .klaviyo-close-form').addEventListener("click", closeBtnEvent);
            ...
            emailInput.addEventListener("change", (e) => {
              pushDataLayer("exp_pop_car_retent_inp_fredeluk_email", "Email", "Input", "Pop up Get 10% Off plus Free Next-Day UK Delivery! UK");
            });
          } else {
            blockVisibility(selector, "exp_pop_car_retent_vis_firorduca_view", "Pop up view", "Pop up Get 10% Off Your First Order! USA, Canada, Australia");
            closeBtnEvent = (e) => {
              pushDataLayer("exp_pop_car_retent_but_firorduca_clos", "Close", "Button", "Pop upGet 10% Off Your First Order! USA, Canada, Australia");
            };
            closeByClickOutsideEvent = (e) => {
              if (e.target.closest('div[role="dialog"]')) return;
              pushDataLayer("exp_pop_car_retent_backd_firorduca_clos", "Close", "Button", "Pop upGet 10% Off Your First Order! USA, Canada, Australia");
            };
            $el('div[role="dialog"] .klaviyo-close-form').removeEventListener("click", closeBtnEvent);
            $el('div[role="dialog"] .klaviyo-close-form').addEventListener("click", closeBtnEvent);
            $el('div[role="dialog"] .klaviyo-close-form').closest('div[role="dialog"]').parentElement.removeEventListener("mousedown", closeByClickOutsideEvent);
            ...
            const emailInput = elem.querySelector('input[id^="email"]');
            emailInput.addEventListener("change", (e) => {
              pushDataLayer("exp_pop_car_retent_inp_firorduca_email", "Email", "Input", "Pop up Get 10% Off Your First Order! USA, Canada, Australia");
            });
          }
          ...
          elem.addEventListener("mousedown", (e) => {
            ...
            if (this.country === "UK") {
              if (target.closest('button[data-popup="email"]')) {
                pushDataLayer("exp_pop_car_retent_but_fredeluk_getdis", "Get discount", "Button", "Pop up Get 10% Off plus Free Next-Day UK Delivery! UK");
              }
              if (target.closest(".crs-promo-form__close")) {
                pushDataLayer("exp_pop_car_retent_but_fredeluk_no", "No, thanks", "Button", "Pop up Get 10% Off plus Free Next-Day UK Delivery! UK");
              }
              if (target.closest(".crs-promocode__copy-btn")) {
                pushDataLayer("exp_pop_car_retent_but_youlisuk_code", "Promo code", "Button", "Pop up You are on the list UK");
              }
              if (target.closest('button[data-popup="promocode"]')) {
                $el('div[role="dialog"] .klaviyo-close-form').removeEventListener("click", closeBtnEvent);
                pushDataLayer("exp_pop_car_retent_but_youlisuk_cont", "Continue shopping", "Button", "Pop up You are on the list UK");
              }
              if (target.closest(".crs-promo-form__enhance")) {
                pushDataLayer("exp_pop_car_retent_but_youlisuk_exper", "Enhance your experience with us", "Button", "Pop up You are on the list UK");
              }
            } else {
              if (target.closest('button[data-popup="email"]')) {
                pushDataLayer("exp_pop_car_retent_but_firorduca_getdis", "Get discount", "Button", "Pop up Get 10% Off Your First Order! USA, Canada, Australia");
              }
              if (target.closest(".crs-promo-form__close")) {
                $el('div[role="dialog"] .klaviyo-close-form').removeEventListener("click", closeBtnEvent);

                pushDataLayer("exp_pop_car_retent_but_firorduca_no", "No, thanks", "Button", "Pop up Get 10% Off Your First Order! USA, Canada, Australia");
              }
              if (target.closest(".crs-promocode__copy-btn")) {
                pushDataLayer("exp_pop_car_retent_but_youlisuca_code", "Promo code", "Button", "Pop up You are on the list USA, Canada, Australia");
              }
              if (target.closest('button[data-popup="promocode"]')) {
                $el('div[role="dialog"] .klaviyo-close-form').removeEventListener("click", closeBtnEvent);

                pushDataLayer("exp_pop_car_retent_but_youlisuca_cont", "Continue shopping", "Button", "Pop up You are on the list USA, Canada, Australia");
              }
              if (target.closest(".crs-promo-form__enhance")) {
                pushDataLayer("exp_pop_car_retent_but_youlisuca_exper", "Enhance your experience with us", "Button", "Pop up You are on the list USA, Canada, Australia");
              }
            }
          });
          ...
          titleSelectors.forEach((selector) => {
            ...
            if (title) {
              title.innerHTML = this.country === "UK" ? "Get <span>10% Off</span> Plus Free Next-Day UK Delivery!" : "Get <span>10% Off</span> <br> Your First Order!";
            }
          });
          ...
          `;
          elem.querySelector("button.needsclick.go397051626:first-child").parentElement.parentElement.insertAdjacentHTML("afterend", exitButtonHtml);
      ...
      waitForElement(".crs-promo__blocks").then((elem) => {
        elem.addEventListener("mousedown", (e) => {
          if (e.target.tagName === "A") {
            ...
            pushDataLayer("exp_pop_car_retent_but_popsale_title", `${title} - Shop Now`, "Button", "Pop up Winter sale - Up to 60% Off");
          }
        });
      });
                ...
                <div class="crs-cart__product">
                  ...
                  <div class="crs-cart__product-content">
                    <div class="crs-cart_product-header">
                      <h3 class="crs-cart__product-title">${item.product_name} <span class="crs-cart__product-qty">(${item.qty})</span></h3>
    ...
    insertPopups() {
        ...
        <style>
          ...
          @media screen and (min-width: 768px) {
            ...
            .crs-promo__block-header {
              ...
              align-items: center;
              padding: 0;
              background: linear-gradient(0deg, var(--H1-Font, #333) 0%, var(--H1-Font, #333) 100%), url(<path-to-image>), lightgray 0px -72.789px / 100% 450.802% no-repeat;
            }
            .crs-promo__block-img {
              grid-column: 1 / 2;
              grid-row: 2 / 3;
      ...
      const cartPopupHtml = /* HTML */ ` <style>
        ...
        <dialog id="cart-popup" class="crs-dialog crs-cart">
          <div class="crs-dialog__wrap">
            ...
            <div class="crs-dialog__descr"><span class="crs-dialog__descr-icon">${icons.fire}</span> High Demand! Limited stock available. Secure yours now.</div>
      ...
      $el("#cart-popup .crs-promocode__copy-btn").addEventListener("click", (event) => {
        pushDataLayer("exp_pop_car_retent_but_with_prod_code", "Promo code", "Button", "Pop up Check out now and get 10% Off your first order");
      });
      waitForElement("#cart-popup").then(() => {
        if (this.country === "UK") {
          blockVisibility("#cart-popup", "exp_pop_car_retent_vis_popchecuk_view", "Pop up view", "Pop up Check out now and get 10% off your first order + Free next-day UK delivery UK");
          $el(".crs-cart__checkout").addEventListener("mousedown", () => {
            pushDataLayer("exp_pop_car_retent_but_popchecuk_comp", "Complete my order now", "Button", "Pop up Check out now and get 10% off your first order + Free next-day UK delivery UK");
          });
        } else {
          blockVisibility("#cart-popup", "exp_pop_car_retent_vis_popchecuca_view", "Pop up view", "Pop up Check out now and get 10% off your first order USA, Canada, Australia");
          $el(".crs-cart__checkout").addEventListener("mousedown", () => {
            pushDataLayer("exp_pop_car_retent_but_popchecuca_comp", "Complete my order now", "Button", "Pop up Check out now and get 10% off your first order USA, Canada, Australia");
          });
        }
      });
      waitForElement("#promo-popup").then(() => {
        blockVisibility("#promo-popup", "exp_pop_car_retent_vis_popsale_view", "Pop up view", "Pop up Winter sale - Up to 60% Off");
      });
    }
  }
