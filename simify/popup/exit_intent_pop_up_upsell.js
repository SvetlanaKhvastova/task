...
class IntentPopup {
  ...
  reDesignHero() {
    ...
    waitForElement(".hero-body").then((el) => {
      ...
      if (window.innerWidth > 768) {
        ...
        waitForElement(".new_pro-grid").then((i) => {
          if (!$el("#bDAYBanner")) {
            this.insert(this.bDAYBanner(), ".new_pro-grid", "afterbegin");
          }
        });
      } else {
        if (!$el("#bDAYBanner")) {
          this.insert(this.bDAYBanner(), ".hero-body", "afterbegin");
        }
  ...
  bDAYBanner() {
    const bDAYBannerHtml = /* HTML */ `
      ...
      <div id="bDAYBanner" style="display: none;">
        <p><b>🎂 BDAY SALE 25% OFF ⏰</b> <span class="days_txt"></span> <span class="hours_txt"></span> <span class="minutes_txt"></span> <span class="seconds_txt"></span> LEFT</p>
      </div>
    `;
    return bDAYBannerHtml;
  }
