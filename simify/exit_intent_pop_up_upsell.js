...
class IntentPopup {
  ...
  init() {
    ...
    if (currentUrl.includes(this.targetUrl) && this.targetUrl === "/products") {
      ...
      if (currentPath === "/products/ultd-as-es" || currentPath === "/products/ultd-ch-es" || currentPath === "/products/ultd-eu-uk-es" || currentPath === "/products/ultd-jp-es" || currentPath === "/products/ultd-sk-es" || currentPath === "/products/ultd-am-ca-es" || currentPath === "/collections/esim-asia/products/ultd-jp-es" || currentPath === "/collections/esim-asia/products/ultd-as-es" || currentPath === "/collections/esim-europe/products/ultd-eu-uk-es" || currentPath === "/collections/esim-usa/products/ultd-am-ca-es" || currentPath === "/collections/esim-asia/products/ultd-sk-es" || currentPath === "/collections/esim-asia/products/ultd-ch-es") {
  ...
  removePopupClient() {
    waitForElement('[aria-label="POPUP Form"]').then((i) => {
      $el('[aria-label="POPUP Form"]')?.closest(".kl-private-reset-css-Xuajs1")?.closest(".kl-private-reset-css-Xuajs1")?.closest(".needsclick").parentElement.remove();
    });
  }
  showIntentPopup() {
    ...
    $$el("[data-discount]").forEach((btn) => {
      btn.addEventListener("click", (event) => {
        ...
        if (event.currentTarget.dataset.target === "popup") {
          pushDataLayer("exp_pdp_enhanc_click_expopup_promo", "Promo Code", "Click", "Exit intent pop-up Wait! Don’t leave without staying connected!");
        }
      });
    });
  }
          ...
          <div class="video-explanation__block">
            ...
            <div class="video-explanation__lists">
              <div class="video-explanation__iframe">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/OpbckLzqF-s?si=5tiqW6esFdUfkKDw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
              ...
              <ul class="learn-more__list">
                ...
                <li>
                  ...
                  <ul class="learn-more__details">
                    ...
                    <li>Android: Settings > Connections > SIM Manager > Add Mobile/eSIM Plan > Enter Details Manually.</li>
                  </ul>
                </li>
  ...
  newInfoElemForInput() {
    const infoElem = /* HTML */ `
      <style>
        ...
        .new_pro-grid .ProductForm__Variants .SizeSwatchList.HorizontalList input[type="radio"]:checked + label .info-elem {
          border-top: none;
          background: #fed786;
        }
      </style>
  ...
  newPdpReDesignInput() {
    const newElemStyle = /* HTML */ `
      <style>
        ...
        .new_pro-grid .ProductForm__Variants .HorizontalList--spacingTight .HorizontalList__Item .SizeSwatch > div:nth-child(2) .Pro-varint-price-inner {
          color: #333f48;
          font-size: 18px;
          font-weight: 600;
          line-height: 26px;
        ...
        .new_pro-grid .ProductForm__Variants .HorizontalList--spacingTight .HorizontalList__Item .SizeSwatch > div:nth-child(2) span.per-day-txt {
          color: #333f48;
          font-size: 14px;
          font-weight: 500;
          line-height: 23.1px;
    ...
    const variantItem2 = $$el(".new_pro-grid .ProductForm__Variants .HorizontalList--spacingTight .HorizontalList__Item .SizeSwatch > div:nth-child(2)");
