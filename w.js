console.log("%c EXP: Exit intent popup (DEV: YK)", "background: #3498eb; color: #fccf3a; font-size: 20px; font-weight: bold;");
...
fonts.href = "https://fonts.googleapis.com/css2?family=Bitter:ital,wght@0,400;0,700;1,600&family=Lato:wght@400;700&display=swap";
