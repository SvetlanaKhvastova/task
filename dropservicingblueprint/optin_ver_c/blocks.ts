    ...
    <div class="wrapper">
      ...
      <div class="hero_wrapper">
        ...
        <div class="video_wrapper">
          <div class="loader" id="video_loader"></div>
          <div class="video">
            <div
              class="wistia_embed wistia_async_ilo2gdof4l wistia_embed_initialized"
...
export const blockersPopupContentBlock = (
  ...
  return /* HTML */ `
    ...
    <div class="video_wrapper">
      ...
      <div class="video">
        <div class="wistia_embed wistia_async_${video}" style="width:100%;height:100%;"></div>
      </div>
    </div>
