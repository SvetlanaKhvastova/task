    ...
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        if (target.classList.contains("lav-cancel__text")) {
          isElementInViewport(target, ["exp_improving_pdp_free_can", "Free cancellation", "Visibility", "Under booking"]);
        }
        ...
        if (target.classList.contains("looking")) {
          isElementInViewport(target, ["exp_improving_pdp_add_info", "Additional info", "Visibility", "Additional info"]);
        }
        ...
        if (target.classList.contains("popup")) {
          isElementInViewport(target, ["exp_improving_pdp_pp_s_v", target.dataset.step, "Visibility", "Popup PDP- Checkout/Custom booking form"]);
        }
      }
    });
  }, observerOptions);
