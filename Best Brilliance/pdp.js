    ...
    if (document.querySelector("#shopify-section-product-template")) {
        ...
        let styles = /*html */ `
          <style>
              ...
              .Product__Info div[class*="PriceList"] .Price--highlight{
                  margin: 0 !important;
                  font-weight: 600;
                  font-size: 22px;
                  line-height: 36px;
              ...
              .Product__Info div[class*="PriceList"] .Price--compareAt{
                  font-weight: 600;
                  font-size: 22px;
                  line-height: 36px;
              ...
              .Product__Info .Price--compareAt::before{
                  content: unset;
              }
              .Product__Info .ProductItem__Label--onSale{
                  margin: 0 !important;
              }
              .ProductForm__Error{
                  margin-bottom: 10px;
              ...
              .Product__Info .pdp-description,
              .Product__Info .sale-msg-box-light,
              .Product__Info .settingsmsg,
              .Product__Info .under-price{
                  display: none;
              }
              /*certified_popup */
              .certified_popup{
            ...
            <section class="descr_box">
              ...
              <div class="full_descr_block">
                  ...
                  <div class="inform_wrap">
                      ...
                      <p>With a personal Zoom consultation, which gives you direct access to an expert jeweler, you may easily find
                      ...
                      <div class="answer_questions_block">
                          ...
                          <ul>
                              ...
                              <li><span class="list_style_circle"></span>What’s the difference between natural, lab grown diamonds and moissanite stones</li>
                          </ul>
              ...
              <div class="new_present_box">
                  ...
                  <div class="present_descr_wrap">
                      <div class="present_absolute mob_var">
                          ...
                          <p>Free gift for all orders above $3000</p>
                      </div>
      ...
      `
        ...
        let afirm = setInterval(function () {
            if (document.querySelector('.affirm-as-low-as')) {
                clearInterval(afirm)
                document.querySelector('.expert__new_btn').after(document.querySelector('.affirm-as-low-as'))
                document.querySelector('.affirm-as-low-as').style.marginTop = '10px'
            }
        }, 100)
        setTimeout(function () {
            if (!document.querySelector('.affirm-as-low-as')) {
        ...
        document.querySelector('.discount_block p').innerText = document.querySelector('.Product__Info .ProductItem__Label--onSale').innerText
