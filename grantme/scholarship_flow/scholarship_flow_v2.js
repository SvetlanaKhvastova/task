...
.new_schedule .nav_steps svg[data-navsteps="4"],
...
.calc_step_fourth > p > span{
  padding-left: 24px;
  position: relative;
}
.calc_step_third > p > span + span,
.calc_step_fourth > p > span + span{
  margin-top: 12px;
}
.calc_step_third > p > span::before,
.calc_step_fourth > p > span::before{
  content: "";
  position: absolute;
  top: 50%;
  left: 0;
...
#yourInformationForm .next_btn_for_parent:disabled{
  background: #cccccc;
  color: #ffffff;
}
.add_guests_btn {
...
#yourParentForm label.no_content {
  border: 1px solid #cccccc;
}
...
#yourParentForm .your_information_wrapper > div + div,
#yourParentForm .your_parent_information_wrapper > div + div,
#yourParentForm .your_information_wrapper > div > div + div,
#yourParentForm .your_parent_information_wrapper > div > div + div{
  margin-top: 12px;
}
#yourInformationForm input,
#yourParentForm input{
  font-family: "Lato", sans-serif;
  width: 100%;
  outline: none;
  border: none;
...
#yourParentForm label > span.is_active{
  top: 4px;
  left: 12px;
  transform: unset;
  font-size: 12px;
...
@media (min-width: 768px) {
  ...
  #yourParentForm .your_information_wrapper > div,
  #yourParentForm .your_parent_information_wrapper > div{
    display: flex;
    justify-content: space-between;
    align-items: flex-start;
    margin-bottom: 16px;
  ...
  #yourParentForm .your_information_wrapper > div:nth-child(2) > div,
  #yourParentForm .your_parent_information_wrapper > div:nth-child(2) > div{
    width: 48%;
  }
  .your_parent_information_wrapper {
    margin: 16px 0 24px;
    ...
    <section class="new_schedule_box" id="newScheduleBox">
      ...
      <div class="new_schedule">
            <div class="nav_steps">
                ...
                <p>Select a Day</p>
                <p><span class="step_active">1</span>/<span class="step_all">3</span></p>
            </div>
...
<path d="M14.002 4.9958L2.67436 12.874L4.32699 8.00498L0 4.9958H5.34837L7.001 0.126465L8.65363 4.9958H14.002ZM7.00142 9.86513L10.0951 9.24213L11.3277 12.874L7.00142 9.86513Z" fill="#2DAF6B"/>
    ...
    if (document.querySelector(".greetings_box")) {
      ...
      if (paramsLocation.get("user_type") === "parent") {
        ...
        if (!document.querySelector("#yourInformationForm .next_btn_for_parent").classList.contains("is_hidden")) {
          document.querySelector("#yourInformationForm .next_btn_for_parent").classList.add("is_hidden");
        }
        ...
        if (document.querySelector("#yourInformationForm .next_btn_for_parent").classList.contains("is_hidden")) {
          document.querySelector("#yourInformationForm .next_btn_for_parent").classList.remove("is_hidden");
        }
        document.querySelector(".step_all").textContent = "4";
    ...
    if (document.querySelector(".new_schedule")) {
      document.querySelector(".new_schedule .nav_steps svg").addEventListener("click", (el) => {
        ...
        if (el.currentTarget.getAttribute("data-navsteps") === "4") {
          pushDataLayer("exp_bookpage_calendar_back_3", "Back step 4", "Button", "Calendar");
          document.querySelector(".nav_steps svg").setAttribute("data-navsteps", "3");
          document.querySelector(".calc_step_third > h3").textContent = "Your Information";
          document.querySelector(".new_schedule .nav_steps > p .step_active").textContent = "3";
          if (document.querySelector(".your_information_wrapper ").classList.contains("is_hidden")) {
            document.querySelector(".your_information_wrapper ").classList.remove("is_hidden");
          }
          document.querySelector(".your_parent_information_wrapper").classList.add("is_hidden");
          if (document.querySelector("#yourInformationForm .next_btn_for_parent").classList.contains("is_hidden")) {
            document.querySelector("#yourInformationForm .next_btn_for_parent").classList.remove("is_hidden");
          }
          if (!document.querySelector("#yourInformationForm .schedule_call_btn").classList.contains("is_hidden")) {
    ...
    if (document.querySelectorAll("#yourInformationForm")) {
      ...
      document.querySelectorAll("#yourInformationForm input").forEach((i) => {
        ...
        setTimeout(() => {
          if (document.querySelector(`.text_validation.phone_number_var`) !== null) {
            ...
            document.querySelector("#yourInformationForm .next_btn_for_parent").disabled = true;
          }
        }, 500);
      ...
      document.querySelector("#yourInformationForm .next_btn_for_parent").addEventListener("click", (e) => {
        e.preventDefault();
        document.querySelector(".path-start-free-trial.path-schedule-consultation #scholarshipListContent .col-lg-7.center").scrollIntoView({ block: "start", behavior: "smooth" });
        pushDataLayer("exp_bookpage_calendar_schedule", "Next for Parent", "Button", "Calendar");
        e.target.classList.add("is_hidden");
        document.querySelector(".calc_step_third > h3").textContent = "Your Parent Information";
        document.querySelector(".step_active").textContent = "4";
        document.querySelector(".your_information_wrapper").classList.add("is_hidden");
        document.querySelector(".nav_steps svg").setAttribute("data-navsteps", "4");
        if (document.querySelector(".your_parent_information_wrapper").classList.contains("is_hidden")) {
          document.querySelector(".your_parent_information_wrapper").classList.remove("is_hidden");
        }
        if (document.querySelector("#yourInformationForm .schedule_call_btn").classList.contains("is_hidden")) {
          document.querySelector("#yourInformationForm .schedule_call_btn").classList.remove("is_hidden");
