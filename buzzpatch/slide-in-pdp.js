...
let run = setInterval(function () {
  if (document.querySelector(".js-heading .btn-primary") != null && document.querySelector("#getNow > img.js-mobile.days") != null) {
      ...
      document
        ...
        .insertAdjacentHTML(
          ...
          setPack(
            ...
            packages[i].price,
            packages[i].packs,
            packages[i].regularPrice,
            packages[i].salePrice,
            packages[i].offPrice,
            packages[i].bestDeal,
            packages[i].topSeller
          )
        )
    ...
    document.addEventListener("click", (e) => {
      if (
        ((e.target.closest(".navbar") || e.target.closest("header") || e.target.closest("#included") || e.target.closest(".js-mobile")) &&
          e.target.classList.contains("btn-primary")) ||
        e.target.classList.contains("btn-close") ||
        e.target.classList.contains("popup_slide-in")
      ) {
        e.preventDefault()
        document.querySelector(".popup_slide-in").classList.toggle("active")
        document.body.classList.toggle("fix-scroll")
