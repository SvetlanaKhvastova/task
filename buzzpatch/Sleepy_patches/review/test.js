...
const waitForReviewsImg = setInterval(() => {
  if (document.querySelector("#addToCart + img")) {
    ...
    document.querySelector("#addToCart + img").insertAdjacentHTML(
      "afterend",
      `
...
const waitForReviewsBlock = setInterval(() => {
  if (document.querySelector(".jdgm-rev-widg__body") && document.querySelector(".jdgm-rev-widg__summary-text") && document.querySelectorAll(".jdgm-histogram__percentage")[4]) {
    ...
    let observer = new MutationObserver((mutations) => {
      for (let mutation of mutations) {
        const reviewsId = ["ad38abe4-a6a3-42ba-a9fc-d86a90674df1", "07d007df-e65e-4339-a7d5-1a88da652ad7", "21605032-8557-4651-a717-9306105509f9"]
