    ...
    <div class='tooltip_wrapper'>
      ...
      <div class='tooltip_info'>
        <div>
         ...
         <span>${svg.starIcon}${svg.starIcon}${svg.starIcon}${svg.starIcon}${svg.starIcon}</span>
        </div>
        <p>${bundlesInfo.ver_b.subTitleTooltip}</p>
        <b>${bundlesInfo.ver_b.boldTitleTooltip}</b>
      </div>
    </div>
  ...
  <div class='tooltip_block'>
    <div class='tooltip_wrapper'>
      ...
      <div class='tooltip_info'>
        ...
        <b>${bundlesInfo.ver_c.boldTitleTooltip}</b>
      </div>
    </div>
