...
let mut = new MutationObserver(function (muts) {
  ...
  if (
    sidebarLinks[0].classList.contains("sidebar__item-link--active") &&
    document.querySelector(".signTemplate__title") != null &&
    document.querySelector(".signTemplate__templateField-select-wrapper") != null &&
    count == 0
  ) {
    mut.disconnect()
    count = 1
