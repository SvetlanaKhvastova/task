...
<style>
    #product .specifics.buttons button.btn.bag span:after{
        width: 16px;
        height: 22px;
    ...
    .core section .col-sm-8, .core section .col-sm-1, .core section .col-sm-2,
    .core section .col-sm-3, .core section .col-sm-4, .core section .col-sm-5,
    .core section .col-sm-6, .core section .col-sm-7, .core section .col-sm-8,
    .core section .col-sm-9, .core section .col-sm-10, .core section .col-sm-11,
    .core section .col-sm-12{
        float: unset;
    }
...
function start() {
  ...
  tag.filter(({ tag }, i) => {
    let text = document.querySelector("section .col-sm-8").textContent.toLocaleLowerCase().includes(tag.toLocaleLowerCase())
    let textSecondBlock = document.querySelector("section .col-sm-4").textContent.toLocaleLowerCase().includes(tag.toLocaleLowerCase())
  ...
  document.querySelector(".details").addEventListener("click", () => {
    ...
    document.querySelector(".core section").scrollIntoView({ block: "center", behavior: "smooth" })
  })
